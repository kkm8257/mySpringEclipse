...
public class Chef {
	...
	//Component를 해놓으면 자동생성이 된다.
	//@Data 를하면 데이터를 저장하는 객체라는 표시 ->lombok의 기능을 쓰기위해서,  lombok이 setter getter생성자 toString() 등을 자동으로 생성하도록 하는어노테이
	//java파일 밑에 C모양의 Chef를 눌러보면 toString()이랑 생성자가 생겨져있
